(function (root, factory) {
  ...
  function InputValues(patronymic, name, surname, email, login) {
    this.patronymic_bqa69w$_0 = patronymic;
    this.name_vh0p3h$_0 = name;
    this.surname_b1exa9$_0 = surname;
    this.email_muzrq8$_0 = email;
    this.login_jigzt9$_0 = login;
  }
  Object.defineProperty(InputValues.prototype, 'patronymic', {
    get: function () {
      return this.patronymic_bqa69w$_0;
    }
  });
  Object.defineProperty(InputValues.prototype, 'name', {
    get: function () {
      return this.name_vh0p3h$_0;
    },
    set: function (name) {
      this.name_vh0p3h$_0 = name;
    }
  });
  Object.defineProperty(InputValues.prototype, 'surname', {
    get: function () {
      return this.surname_b1exa9$_0;
    }
  });
  Object.defineProperty(InputValues.prototype, 'email', {
    get: function () {
      return this.email_muzrq8$_0;
    }
  });
  Object.defineProperty(InputValues.prototype, 'login', {
    get: function () {
      return this.login_jigzt9$_0;
    }
  });
  InputValues.prototype.set_puj7f4$ = function (name, value) {
    this.set_puj7f4$(name, value);
  };
  InputValues.prototype.get_61zpoe$ = function (name) {
    return this.get_61zpoe$(name);
  };
  InputValues.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'InputValues',
    interfaces: [Item]
  };
  InputValues.prototype.component1 = function () {
    return this.patronymic;
  };
  InputValues.prototype.component2 = function () {
    return this.name;
  };
  InputValues.prototype.component3 = function () {
    return this.surname;
  };
  InputValues.prototype.component4 = function () {
    return this.email;
  };
  InputValues.prototype.component5 = function () {
    return this.login;
  };
  InputValues.prototype.copy_x0a6t6$ = function (patronymic, name, surname, email, login) {
    return new InputValues(patronymic === void 0 ? this.patronymic : patronymic, name === void 0 ? this.name : name, surname === void 0 ? this.surname : surname, email === void 0 ? this.email : email, login === void 0 ? this.login : login);
  };
  InputValues.prototype.toString = function () {
    return 'InputValues(patronymic=' + Kotlin.toString(this.patronymic) + (', name=' + Kotlin.toString(this.name)) + (', surname=' + Kotlin.toString(this.surname)) + (', email=' + Kotlin.toString(this.email)) + (', login=' + Kotlin.toString(this.login)) + ')';
  };
  InputValues.prototype.hashCode = function () {
    var result = 0;
  ...
  InputValues.prototype.equals = function (other) {
  ...
  function ModalWindow$lambda$lambda(closure$inputValues, closure$setValues) {
    return function (it) {
      var tmp$;
      var element = Kotlin.isType(tmp$ = it.target, HTMLInputElement) ? tmp$ : throwCCE();
      var newMap = closure$inputValues.v;
      newMap.set_puj7f4$(element.name, element.value);
      closure$setValues.v(newMap);
      return Unit;
    };
  }
  function ModalWindow$lambda$lambda_0(closure$props, closure$inputValues) {
    return function (it) {
      it.preventDefault();
      closure$props.add(closure$inputValues.v);
      return Unit;
    };
  }
  function ModalWindow$lambda($receiver, props) {
    var tmp$ = useState(new InputValues('', '', '', '', ''));
    var component1$result;
    component1$result = tmp$[0];
    var component2$result;
    component2$result = tmp$[1];
    var inputValues = {v: component1$result}
    , setValues = {v: component2$result};
    var changeHandler = ModalWindow$lambda$lambda(inputValues, setValues);
    var submitHandler = ModalWindow$lambda$lambda_0(props, inputValues);
    ...
    while (tmp$_0.hasNext()) {
      ...
      $receiver_4.value = inputValues.v.get_61zpoe$(element.name).toString();
  ...
  function UsersList$lambda$lambda$lambda$lambda$lambda$lambda$lambda(closure$props, closure$item) {
    return function (it) {
      var tmp$;
      closure$props.delete(Kotlin.isType(tmp$ = closure$item, UserItem) ? tmp$ : throwCCE());
      return Unit;
    };
  }
  function UsersList$lambda($receiver, props) {
    ...
    while (tmp$.hasNext()) {
      ...
      $receiver_0_0.key = hashCode(item).toString();
  ...
  function UserItem(patronymic, name, surname, email, login) {
    this.patronymic_lainte$_0 = patronymic;
    this.name_bdavgf$_0 = name;
    this.surname_nkhr01$_0 = surname;
    this.email_6s7ssy$_0 = email;
    this.login_3fp0vz$_0 = login;
  }
  Object.defineProperty(UserItem.prototype, 'patronymic', {
    get: function () {
      return this.patronymic_lainte$_0;
    }
  });
  Object.defineProperty(UserItem.prototype, 'name', {
    get: function () {
      return this.name_bdavgf$_0;
    },
    set: function (name) {
      this.name_bdavgf$_0 = name;
    }
  });
  Object.defineProperty(UserItem.prototype, 'surname', {
    get: function () {
      return this.surname_nkhr01$_0;
    }
  });
  Object.defineProperty(UserItem.prototype, 'email', {
    get: function () {
      return this.email_6s7ssy$_0;
    }
  });
  Object.defineProperty(UserItem.prototype, 'login', {
    get: function () {
      return this.login_3fp0vz$_0;
    }
  });
  UserItem.$metadata$ = {
    kind: Kind_CLASS,
  ...
  function app$lambda$lambda(closure$setUserList, closure$userList) {
    return function (user) {
      ...
      while (tmp$_0.hasNext()) {
        var element = tmp$_0.next();
        if (hashCode(element) !== user.hashCode())
  ...
  function app$lambda$lambda$lambda$lambda_0(closure$addUser) {
    return function ($receiver) {
      var tmp$;
      $receiver.add = typeof (tmp$ = closure$addUser) === 'function' ? tmp$ : throwCCE();
      return Unit;
    };
  }
  ...
  function app$lambda($receiver, it) {
    var tmp$ = useState(userItemsOptions);
    var userList = tmp$[0];
  ...
  _.Item = Item;
  _.UserItem = UserItem;
  Object.defineProperty(_, 'userItemsOptions', {
    get: function () {
      return userItemsOptions;
    },
    set: function (value) {
      userItemsOptions = value;
    }
  });
  ...
  userItemsOptions = mutableListOf([new UserItem('\u0418\u0432\u0430\u043D', '\u0418\u0432\u0430\u043D\u043E\u0432', '\u0418\u0432\u0430\u043D\u043E\u0432\u0438\u0447', 'email', 'login')]);
  app = fc(app$lambda);
  main();
